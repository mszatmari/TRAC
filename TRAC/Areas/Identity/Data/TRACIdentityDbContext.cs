...
namespace TRAC.Areas.Identity.Data
{
    public class TRACIdentityDbContext : IdentityDbContext<IdentityUser>
    {
        public TRACIdentityDbContext(DbContextOptions<TRACIdentityDbContext> options)
            : base(options)
        {
        }
